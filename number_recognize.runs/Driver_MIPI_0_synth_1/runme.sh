...
HD_PWD='D:/xilinix_lab/number_recognize/number_recognize.runs/Driver_MIPI_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_MIPI_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_MIPI_0.tcl
